    ...
    try {
      ...
      db = await openDatabase(
        ...
        onCreate: (db, version) async {
          ...
          var tokens = [
            'CREATE TABLE tokens(id INTEGER PRIMARY KEY AUTOINCREMENT, chain_id INTEGER,owner TEXT, token_address TEXT, type INTEGER, name TEXT, symbol TEXT,decimals INTEGER, total_supply INTEGER,logo TEXT,invite_address TEXT,enable_bot INTEGER, is_kyc INTEGER, is_audit INTEGER,is_parsed INTEGER,created_at INTEGER,updated_at INTEGER);',
